...
date: "2026-02-01"
tags: ["AI", "Solar", "Upstage"]
category: "프로젝트"
summary: "채권/펀드 Prospectus를 자동 분석해 요약, 조건 추출, Q&A를 제공하는 AI Agent 프로젝트."
---

# "BondInsight AI Agent" 요약
채권/채권 펀드 Prospectus를 자동 분석해 요약, 조건 추출, 리스크 중심 요약, Worst Case 시나리오를 생성하여 제공하는 AI Agent
...
![img.png](/public/assets/images/260201/mermaid.svg)
